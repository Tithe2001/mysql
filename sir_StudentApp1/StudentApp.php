...
//  include_once
 ...
 if(isset($_POST['btn_Name'])){
    ...
    $student= new Student("",$name,$result,$batch);
    $save= $student->save();
    if($save){
      echo $save;
      // unset($_POST['id']);
...
if(isset($_POST['btn_update'])){
    ...
    $student= new Student($id,$name,$result,$batch);
...
<body>
       ...
       <div>
         <h1> New Student</h1>
            ...
            <label for="n">Give Your Grade</label> <br>
            <input type="text" name="result" id="result"> <br> <br>
            <label for="n">Batch</label> <br>
       ...
       <div>
         <h1> Update Student</h1>
            ...
            <label for="n">Give Your Grade</label> <br>
            <input type="text" name="result" id="result" value="<?php echo $search_student['result'] ?>"  > <br> <br>
            <label for="n">Batch</label> <br>
            <input type="text" name="batch" id="batch" value="<?php echo $search_student['batch'] ?>"  > <br> <br>
